...
from envs.jackal_gazebo_envs import JackalGazebo, JackalGazeboEvents
...
class MotionControlContinuous(JackalGazebo):
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        # Implement any additional logic using `options` if necessary
        obs = self._reset_environment()
        
        # Prepare info dictionary
        info = {"initial_position": self.init_position}
...
class MotionControlContinuousEvents(MotionControlContinuous, JackalGazeboEvents):
